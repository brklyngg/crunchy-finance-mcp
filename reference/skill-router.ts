 ...
 *
 * SOURCE: ~/VibeCoding/crunchy-sheets/cloud-functions/src/skill-router.ts
 * PURPOSE: Reference for CRU-51 — extract skill prompts for MCP tool handlers
 * DELETE BEFORE: CRU-55 (package/publish step)
 *
 * Each skill has:
